...
TEST_CASE("Copy", "[rev::z3::expression]")
{
    ...
    auto a = std::make_unique<grev::expression const>(value);

    SECTION("Construction")
    {
        grev::expression const b = *a;
...
TEST_CASE("Move", "[rev::z3::expression]")
{
    ...
    auto a = std::make_unique<grev::expression>(value);

    SECTION("Construction")
    {
        grev::expression const b = std::move(*a);
...
TEST_CASE("Evaluate", "[rev::z3::expression]")
{
    SECTION("Unknown")
    {
        ...
        grev::expression const a(name_a);
    ...
    SECTION("Value")
    {
        ...
        grev::expression const a(value_a);
        ...
        SECTION("Binary")
        {
            ...
            grev::expression const b(value_b);
