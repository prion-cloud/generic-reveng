    ...
    public abstract class DebuggerTestCase
    {
        ...
        public static DebuggerTestCase<byte[]> GetTestCase32_Bytes1()
        {
            ...
            return new DebuggerTestCase<byte[]>(
                ...
                {
                    (
                        new TestInstructionInfo(0xd8, "0x00000000", new byte[] { 0x41 }, "inc ecx"),
                        new IRegisterInfo[]
                        {
                    ...
                    (
                        new TestInstructionInfo(0x87, "0x00000001", new byte[] { 0x4a }, "dec edx"),
                        new IRegisterInfo[]
                        {
                            new TestRegisterInfo("eax", "0x00000000"),
                            new TestRegisterInfo("ebx", "0x00000000"),
        ...
        public static DebuggerTestCase<string> GetTestCase32_File1()
        {
            ...
            return new DebuggerTestCase<string>(
                ...
                {
                    (
                        new TestInstructionInfo(0x10a, "0x00401000", new byte[] { 0xeb, 0x10 }, "jmp 0x401012"),
                        new IRegisterInfo[]
                        {
                            new TestRegisterInfo("eax", "0x00000000"),
                            new TestRegisterInfo("ebx", "0x00000000"),
                    ...
                    (
                        new TestInstructionInfo(0x1ba, "0x00401012", new byte[] { 0xa1, 0xbf, 0x61, 0x41, 0x00 }, "mov eax, dword ptr [0x4161bf]"),
                        new IRegisterInfo[]
                        {
                            new TestRegisterInfo("eax", "0x00000000"),
                            new TestRegisterInfo("ebx", "0x00000000"),
                    ...
                    (
                        new TestInstructionInfo(0x283, "0x00401017", new byte[] { 0xc1, 0xe0, 0x02 }, "shl eax, 2"),
                        new IRegisterInfo[]
                        {
                            new TestRegisterInfo("eax", "0x00000000"),
                            new TestRegisterInfo("ebx", "0x00000000"),
                    ...
                    (
                        new TestInstructionInfo(0x1ba, "0x0040101a", new byte[] { 0xa3, 0xc3, 0x61, 0x41, 0x00 }, "mov dword ptr [0x4161c3], eax"),
                        new IRegisterInfo[]
                        {
                            new TestRegisterInfo("eax", "0x00000000"),
                            new TestRegisterInfo("ebx", "0x00000000"),
                    ...
                    (
                        new TestInstructionInfo(0x244, "0x0040101f", new byte[] { 0x52 }, "push edx"),
                        new IRegisterInfo[]
                        {
                            new TestRegisterInfo("eax", "0x00000000"),
                            new TestRegisterInfo("ebx", "0x00000000"),
                    ...
                    (
                        new TestInstructionInfo(0x244, "0x00401020", new byte[] { 0x6a, 0x00 }, "push 0"),
                        new IRegisterInfo[]
                        {
                            new TestRegisterInfo("eax", "0x00000000"),
                            new TestRegisterInfo("ebx", "0x00000000"),
                    ...
                    (
                        new TestInstructionInfo(0x38, "0x00401022", new byte[] { 0xe8, 0x65, 0x41, 0x01, 0x00 }, "call 0x41518c"),
                        new IRegisterInfo[]
                        {
                            new TestRegisterInfo("eax", "0x00000000"),
                            new TestRegisterInfo("ebx", "0x00000000"),
                    ...
                    (
                        new TestInstructionInfo(0x10a, "0x0041518c", new byte[] { 0xff, 0x25, 0x3c, 0x12, 0x42, 0x00 }, "jmp dword ptr [0x42123c]"),
                        new IRegisterInfo[]
                        {
                            new TestRegisterInfo("eax", "0x00000000"),
                            new TestRegisterInfo("ebx", "0x00000000"),
                            ...
                            new TestRegisterInfo("esi", "0x00000000"),
                            new TestRegisterInfo("edi", "0x00000000"),
                            new TestRegisterInfo("eip", $"0x{S}{S}{S}{S}4fb0")
                        }
                    ),
                    (
                        new TestInstructionInfo(0x1ba, $"0x{S}{S}{S}{S}4fb0", new byte[] { 0x8b, 0xff }, "mov edi, edi"),
                        new IRegisterInfo[]
                        {
                            new TestRegisterInfo("eax", "0x00000000"),
                            new TestRegisterInfo("ebx", "0x00000000"),
                            ...
                            new TestRegisterInfo("esi", "0x00000000"),
                            new TestRegisterInfo("edi", "0x00000000"),
                            new TestRegisterInfo("eip", $"0x{S}{S}{S}{S}4fb2")
                        }
                    ),
                    (
                        new TestInstructionInfo(0x244, $"0x{S}{S}{S}{S}4fb2", new byte[] { 0x55 }, "push ebp"),
                        new IRegisterInfo[]
                        {
                            new TestRegisterInfo("eax", "0x00000000"),
                            new TestRegisterInfo("ebx", "0x00000000"),
                            ...
                            new TestRegisterInfo("esi", "0x00000000"),
                            new TestRegisterInfo("edi", "0x00000000"),
                            new TestRegisterInfo("eip", $"0x{S}{S}{S}{S}4fb3")
                        }
                    ),
                    (
                        new TestInstructionInfo(0x1ba, $"0x{S}{S}{S}{S}4fb3", new byte[] { 0x8b, 0xec }, "mov ebp, esp"),
                        new IRegisterInfo[]
                        {
                            new TestRegisterInfo("eax", "0x00000000"),
                            new TestRegisterInfo("ebx", "0x00000000"),
                            ...
                            new TestRegisterInfo("esi", "0x00000000"),
                            new TestRegisterInfo("edi", "0x00000000"),
                            new TestRegisterInfo("eip", $"0x{S}{S}{S}{S}4fb5")
                        }
                    ),
                    (
                        new TestInstructionInfo(0x22e, $"0x{S}{S}{S}{S}4fb5", new byte[] { 0x5d }, "pop ebp"),
                        new IRegisterInfo[]
                        {
                            new TestRegisterInfo("eax", "0x00000000"),
                            new TestRegisterInfo("ebx", "0x00000000"),
                            ...
                            new TestRegisterInfo("esi", "0x00000000"),
                            new TestRegisterInfo("edi", "0x00000000"),
                            new TestRegisterInfo("eip", $"0x{S}{S}{S}{S}4fb6")
                        }
                    )/*,
                    (
                        new TestInstructionInfo(0x10a, $"0x{s}{s}{s}{s}4fb6", new byte[] { 0xff, 0x25, 0xa0, 0x10, 0x5b, 0x77 }, "jmp dword ptr [0x775b10a0]"),
                        new IRegisterInfo[]
                        {
                            new TestRegisterInfo("eax", "0x00000000"),
                            new TestRegisterInfo("ebx", "0x00000000"),
        ...
        public static DebuggerTestCase<byte[]> GetTestCase64_Bytes1()
        {
            ...
            return new DebuggerTestCase<byte[]>(
                ...
                {
                    (
                        new TestInstructionInfo(0x244, "0x0000000000000000", new byte[] { 0x55 }, "push rbp"),
                        new IRegisterInfo[]
                        {
                    ...
                    (
                        new TestInstructionInfo(0x1ba, "0x0000000000000001", new byte[] { 0x48, 0x8b, 0x05, 0xb8, 0x13, 0x00, 0x00 }, "mov rax, qword ptr [rip + 0x13b8]"),
                        new IRegisterInfo[]
                        {
                            new TestRegisterInfo("rax", "0x0000000000000000"),
                            new TestRegisterInfo("rbx", "0x0000000000000000"),
        ...
        public static DebuggerTestCase<string> GetTestCase64_File1()
        {
            return new DebuggerTestCase<string>(
                ...
                {
                    (
                        new TestInstructionInfo(0x146, "0x0000000000401500", new byte[] { 0x48, 0x83, 0xec, 0x28 }, "sub rsp, 0x28"),
                        new IRegisterInfo[]
                        {
                            new TestRegisterInfo("rax", "0x0000000000000000"),
                            new TestRegisterInfo("rbx", "0x0000000000000000"),
