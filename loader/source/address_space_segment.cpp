...
static_assert(std::is_destructible_v<rev::address_space_segment>);

static_assert(std::is_copy_constructible_v<rev::address_space_segment>);
static_assert(std::is_copy_assignable_v<rev::address_space_segment>);

static_assert(std::is_move_constructible_v<rev::address_space_segment>);
static_assert(std::is_move_assignable_v<rev::address_space_segment>);
